---
title: "SEC-AWS-IAM-POLICY-003 — IAM policy document grants wildcard `resources = [\\"*\\"]`"
description: "tf-analyze rule SEC-AWS-IAM-POLICY-003 (HIGH · security): IAM policy document grants wildcard `resources = [\'*\']`"
keywords: "security, high, terraform, iac, aws, cis-1.16, mitre-T1078.004, cwe-269, nist-csf-pr.ac-4, nist-800-53-ac-6, csa-ccm-iam-09"
---
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "SEC-AWS-IAM-POLICY-003 \u2014 IAM policy document grants wildcard `resources = [\\\"*\\\"]`",
  "description": "Scope `resources` to specific ARNs or ARN patterns. For S3 use\n`arn:aws:s3:::my-bucket/*`; for KMS use the key ARN; for EC2 use\n`arn:aws:ec2:<region>:<account>:instance/i-*` filtered by tag\nconditions.",
  "url": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-IAM-POLICY-003/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-IAM-POLICY-003/"
  },
  "author": {
    "@type": "Organization",
    "name": "tf-analyze"
  ...
  "keywords": "security, high, terraform, CIS 1.16, MITRE T1078.004, CWE-269",
...
<p><a href="vscode://tfanalyze.tf-analyze/rule/SEC-AWS-IAM-POLICY-003" style="display:inline-block;padding:6px 12px;background:#157878;color:#fff;text-decoration:none;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px">📂 Open in VS Code</a><a href="vscode://tfanalyze.tf-analyze/suppress?id=SEC-AWS-IAM-POLICY-003" style="display:inline-block;padding:6px 12px;background:#fff;color:#c27a00;text-decoration:none;border:1px solid #c27a00;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px;margin-left:6px" title="Add SEC-AWS-IAM-POLICY-003 to .tf-analyze.yaml's ignore_rules in your workspace">📝 Suppress in workspace</a> <span style="color:#666;font-size:12px;margin-left:4px">(requires the <a href="https://marketplace.visualstudio.com/items?itemName=tfanalyze.tf-analyze" style="color:#157878">tf-analyze extension</a>)</span></p>
