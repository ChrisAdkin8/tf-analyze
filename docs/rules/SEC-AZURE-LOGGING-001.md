...
keywords: "security, high, terraform, iac, azure, cis-8.7, mitre-T1562.008, cwe-778, d3-faa, nist-csf-de.cm-1, nist-800-53-au-2, csa-ccm-log-02"
---
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "SEC-AZURE-LOGGING-001 \u2014 Azure Key Vault missing diagnostic settings",
  "description": "Add `azurerm_monitor_diagnostic_setting` targeting the Key Vault with\n`AuditEvent` logs enabled and at minimum a `log_analytics_workspace_id`\ndestination. Without this, secret access and modification events are\nunlogged.",
  "url": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AZURE-LOGGING-001/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AZURE-LOGGING-001/"
  },
  "author": {
    "@type": "Organization",
    "name": "tf-analyze"
...
<p><a href="vscode://tfanalyze.tf-analyze/rule/SEC-AZURE-LOGGING-001" style="display:inline-block;padding:6px 12px;background:#157878;color:#fff;text-decoration:none;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px">📂 Open in VS Code</a><a href="vscode://tfanalyze.tf-analyze/suppress?id=SEC-AZURE-LOGGING-001" style="display:inline-block;padding:6px 12px;background:#fff;color:#c27a00;text-decoration:none;border:1px solid #c27a00;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px;margin-left:6px" title="Add SEC-AZURE-LOGGING-001 to .tf-analyze.yaml's ignore_rules in your workspace">📝 Suppress in workspace</a> <span style="color:#666;font-size:12px;margin-left:4px">(requires the <a href="https://marketplace.visualstudio.com/items?itemName=tfanalyze.tf-analyze" style="color:#157878">tf-analyze extension</a>)</span></p>
