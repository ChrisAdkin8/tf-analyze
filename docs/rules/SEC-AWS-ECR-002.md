---
title: "SEC-AWS-ECR-002 — ECR repository missing image lifecycle policy"
description: "tf-analyze rule SEC-AWS-ECR-002 (MEDIUM · security): ECR repository missing image lifecycle policy"
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "SEC-AWS-ECR-002 \u2014 ECR repository missing image lifecycle policy",
  "description": "Add an `aws_ecr_lifecycle_policy` resource to expire old images:",
  "url": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-ECR-002/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-ECR-002/"
  },
  "author": {
    "@type": "Organization",
    "name": "tf-analyze"
...
<p><a href="vscode://tfanalyze.tf-analyze/rule/SEC-AWS-ECR-002" style="display:inline-block;padding:6px 12px;background:#157878;color:#fff;text-decoration:none;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px">📂 Open in VS Code</a><a href="vscode://tfanalyze.tf-analyze/suppress?id=SEC-AWS-ECR-002" style="display:inline-block;padding:6px 12px;background:#fff;color:#c27a00;text-decoration:none;border:1px solid #c27a00;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px;margin-left:6px" title="Add SEC-AWS-ECR-002 to .tf-analyze.yaml's ignore_rules in your workspace">📝 Suppress in workspace</a> <span style="color:#666;font-size:12px;margin-left:4px">(requires the <a href="https://marketplace.visualstudio.com/items?itemName=tfanalyze.tf-analyze" style="color:#157878">tf-analyze extension</a>)</span></p>
...
- [`SEC-AWS-ECR-001`](./SEC-AWS-ECR-001.md) — ECR repository missing scan-on-push
