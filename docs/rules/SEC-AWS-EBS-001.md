...
keywords: "security, high, terraform, iac, aws, cis-2.2.1, mitre-T1530"
---
...
<script type="application/ld+json">
{
  ...
  "keywords": "security, high, terraform, CIS 2.2.1, MITRE T1530",
...
<p><a href="vscode://tfanalyze.tf-analyze/rule/SEC-AWS-EBS-001" style="display:inline-block;padding:6px 12px;background:#157878;color:#fff;text-decoration:none;border-radius:4px;font-weight:600;font-size:14px;margin-top:6px">📂 Open in VS Code</a> <span style="color:#666;font-size:12px;margin-left:4px">(requires the <a href="https://marketplace.visualstudio.com/items?itemName=tfanalyze.tf-analyze" style="color:#157878">tf-analyze extension</a>)</span></p>
