...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "SEC-AWS-IAM-POLICY-004 \u2014 IAM policy document grants principal `identifiers = [\\\"*\\\"]` (public)",
  "description": "Replace the wildcard principal with the specific account or role\nARNs that should have access. If true public exposure is the\nintent (e.g. a website-hosting bucket), use the resource-specific\npublic-access mechanism (`aws_s3_bucket_policy` ",
  "url": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-IAM-POLICY-004/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://chrisadkin8.github.io/tf-analyze/rules/SEC-AWS-IAM-POLICY-004/"
  },
  "author": {
    "@type": "Organization",
    "name": "tf-analyze"
