 ...
 */
export const LINK_BRIDGE_PARENT_JS = `
 ...
 */
export function injectReportCsp(html: string): string {
  if (!html || html.indexOf('Content-Security-Policy') !== -1) return html;
