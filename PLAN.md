...
State after R30.0 + R30.0.1 + R30.0.2 + R30.0.3 + R30.0.4 ship: 217 rules · 603 pytest + 24 `node:test` · ten surfaces all hardened/coherent · seven taxonomies tagged in catalogue (CIS, PCI-DSS, SOC 2, OWASP IaC, MITRE ATT&CK v17, CWE, MITRE D3FEND).
