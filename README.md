...
| VS Code extension (v0.1.12) | [`vscode-extension/`](vscode-extension/) | [`docs/vscode-extension.md`](docs/vscode-extension.md) — inline diagnostics, Quick Fix, status-bar attack-graph shortcut |
